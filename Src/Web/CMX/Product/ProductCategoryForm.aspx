<%@ Page Title="产品分类管理" Language="C#" MasterPageFile="~/Admin/FormPage.master" AutoEventWireup="true" CodeFile="ProductCategoryForm.aspx.cs" Inherits="CMX_ProductCategoryForm"%>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    <table border="0" class="m_table" cellspacing="1" cellpadding="0" align="Center">
        <tr>
            <th colspan="2">产品分类</th>
        </tr>
        <tr>
