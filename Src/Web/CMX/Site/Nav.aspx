<%@ Page Title="导航管理" Language="C#" MasterPageFile="~/Admin/ManagerPage.master" AutoEventWireup="true" CodeFile="Nav.aspx.cs" Inherits="CMX_Nav" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    <div class="tools_box">
        <div class="tools_bar">
            <a href="NavForm.aspx" class="tools_btn"><span><b class="add">添加导航</b></span></a>
