<%@ Page Title="标题管理" Language="C#" MasterPageFile="~/Admin/ManagerPage.master" AutoEventWireup="true" CodeFile="Title.aspx.cs" Inherits="CMX_Title" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    <div class="toolbar">
        <XCL:LinkBox ID="lbAdd" runat="server" BoxHeight="184px" BoxWidth="440px" Url="TitleForm.aspx"
            IconLeft="~/Admin/images/icons/new.gif" EnableViewState="false"><b>添加标题</b></XCL:LinkBox>
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="ods" AllowPaging="True" AllowSorting="True" CssClass="m_table" PageSize="20" CellPadding="0" GridLines="None" EnableModelValidation="True">
        <Columns>
            ...
            <asp:BoundField DataField="SubjectID" HeaderText="标题" SortExpression="SubjectID" DataFormatString="{0:n0}">
            ...
            <XCL:LinkBoxField HeaderText="编辑" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="TitleForm.aspx?ID={0}" Height="184px" Text="编辑" Width="440px" Title="编辑标题">
