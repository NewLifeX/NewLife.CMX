<%@ Page Title="主题管理" Language="C#" MasterPageFile="~/Admin/ManagerPage.master" AutoEventWireup="true" CodeFile="SubjectForm.aspx.cs" Inherits="CMX_SubjectForm"%>
    ...
    <table border="0" align="Center" width="100%">
        <tr>
            <td align="center">
                ...
                &nbsp;<asp:Button ID="btnCopy" runat="server" CausesValidation="True" Text='另存为新主题' />
