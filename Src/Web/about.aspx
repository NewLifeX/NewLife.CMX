     ...
     <div id="wrap">
       ...
       <div class="mainbody">
               <div class="top_image">
                ...
                <div class="conten">
                    <div class="list">
                        <div id="list_t"><span><strong>产品分类</strong></span></div>
                        <div class="list_meu">
                            <dl> 
			                   <dt><a href="#" class="minus" onclick="showHide(this,'items0');"><span></span>点胶设备</a></dt> 
			                   <dd id="items0"> 
				                  <ul>
					                    <li><a href="#">混合管</a></li>
                                        <li><a href="#">点胶机</a></li>
		                 ...
		                 <dl> 
			                <dt><a href="#" class="plus" onclick="showHide(this,'items1');"><span></span>阿波罗声控</a></dt> 
			                <dd id="items1" style="display:none;"> 
				                  <ul>
					                 <li><a href="#">自动化设备</a></li>
                                     <li><a href="#">阿波罗智能控制器</a></li>
                                     <li><a href="#">阿波罗智能物联网网关</a></li>
				                 </ul> 
			              </dd> 
		              </dl>
                      <dl> 
			                <dt><a href="#" class="plus" onclick="showHide(this,'items2');"><span></span>化工胶水</a></dt> 
			                <dd id="items2" style="display:none;"> 
				                  <ul>
					                 <li><a href="#">水性万能胶</a></li>
                                     <li><a href="#">手袋专用环保喷胶</a></li>
                                     <li><a href="#">双组份水性喷胶</a></li>
                                     <li><a href="#">单组份水性喷胶</a></li>
				                 </ul> 
			              </dd> 
		              </dl>
                             <dl> 
			                <dt><a href="#" class="plus" onclick="showHide(this,'items3');"><span></span>五金模具</a></dt> 
