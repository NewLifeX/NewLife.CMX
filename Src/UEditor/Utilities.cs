    ...
    public class Utilities
    {
        public static string getExtensionForMimeType(string MimeType)
        {
            ...
            switch (MimeType)
            {
                ...
                case "video/ogg": retval = ".ogg"; break;
                case "video/mpeg": retval = ".mpeg"; break;
                case "application/vnd.rn-realmedia": retval = ".rm"; break;
                case "video/avi": retval = ".avi"; break;
                case "application/x-shockwave-flash": retval = ".swf"; break;
        ...
        public static string MimeType(string fileName)
        {
            ...
            switch (Path.GetExtension(fileName).ToLower())
            {
                ...
                case ".ogg": retval = "video/ogg"; break;
