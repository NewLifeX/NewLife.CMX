...
namespace NewLife.CMX
{
    ...
    [DataObject]
    [Description("文章内容")]
    [BindIndex("IX_ArticleContent_ParentID", false, "ParentID")]
    [BindIndex("IU_ArticleContent_ParentID_Version", true, "ParentID,Version")]
    [BindTable("ArticleContent", Description = "文章内容", ConnName = "CMX", DbType = DatabaseType.SqlServer)]
