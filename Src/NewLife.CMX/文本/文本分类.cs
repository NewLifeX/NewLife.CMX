...
namespace NewLife.CMX
{
    ...
    [DataObject]
    [Description("文本分类")]
    [BindIndex("IU_TextCategory_ParentID_Name", true, "ParentID,Name")]
    [BindIndex("IX_TextCategory_Name", false, "Name")]
    [BindIndex("IX_TextCategory_ParentID", false, "ParentID")]
    [BindIndex("PK__TextCate__3214EC272FCF1A8A", true, "ID")]
    ...
    public partial interface ITextCategory
    {
        #region 属性
        /// <summary>名称</summary>
        String Name { get; set; }
