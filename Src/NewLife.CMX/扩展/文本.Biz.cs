...
{
    /// <summary>文本</summary>
    public partial class Text : InfoExtend<Text>
    {
        #region 对象操作
            ﻿
        ...
        public static EntityList<Text> FindAllByInfoID(Int32 infoid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<Text> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
