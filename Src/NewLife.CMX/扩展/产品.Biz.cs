...
{
    /// <summary>产品</summary>
    public partial class Product : InfoExtend<Product>
    {
        #region 对象操作
            ﻿
        ...
        //    entity.InfoID = 0;
        //    entity.Price = 0;
        //    entity.PhotoPath = "abc";
        //    entity.Specification = "abc";
        //    entity.Feature = "abc";
        //    entity.App = "abc";
        //    entity.Fitting = "abc";
        //    entity.Video = "abc";
        ...
        public static EntityList<Product> FindAllByInfoID(Int32 infoid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<Product> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
