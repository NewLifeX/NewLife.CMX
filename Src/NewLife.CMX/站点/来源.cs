...
namespace NewLife.CMX
{
    ...
    [DataObject]
    [Description("来源")]
    [BindTable("Source", Description = "来源", ConnName = "CMX", DbType = DatabaseType.SqlServer)]
