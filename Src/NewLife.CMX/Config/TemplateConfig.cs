...
namespace NewLife.CMX.Config
{
    ...
    public class TemplateConfig : CMXmlConfig<TemplateConfig>
    {
        ...
        [Description("模板样式")]
        public String Style { get { return _TemplateStyle; } set { _TemplateStyle = value; } }
        ...
        [Description("模板根目录")]
        public String Root { get { return _TemplateRootPath; } set { _TemplateRootPath = value; } }
        ...
        [Description("是否调试模式")]
        public Boolean Debug { get { return _IsDebug; } set { _IsDebug = value; } }
        ...
        //private String _GoPage = CMXConfigBase.Current.CurrentRootPath + "/GoPageUrl.ashx";
